...
const MODEL_GROUPS: ModelGroup[] = [
  ...
  },
  {
    ...
    models: [
      { id: 'google:gemini-2.5-pro',         label: 'gemini-2.5-pro',         hint: 'flagship · long context, reasoning, coding' },
      { id: 'google:gemini-2.5-flash',       label: 'gemini-2.5-flash',       hint: 'pragmatic default · fast, balanced' },
      { id: 'google:gemini-2.5-flash-lite',  label: 'gemini-2.5-flash-lite',  hint: 'cheapest stable · high-volume / latency-sensitive' },
    ],
  },
  {
    label: 'Google · Gemini 3 (preview)',
    models: [
      { id: 'google:gemini-3.1-pro-preview',         label: 'gemini-3.1-pro-preview',         hint: 'latest frontier · best Gemini reasoning' },
      { id: 'google:gemini-3-flash-preview',         label: 'gemini-3-flash-preview',         hint: 'next-gen flash · production-leaning preview' },
      { id: 'google:gemini-3.1-flash-lite-preview',  label: 'gemini-3.1-flash-lite-preview',  hint: 'preview · max throughput, lowest cost' },
    ],
  },
];
